...
let describedVersion
try {
    describedVersion = childProcess.execSync('git describe --tags', { encoding:'utf-8' })
} catch {
    describedVersion = 'v1.0.0-0'
}

export let version = describedVersion
